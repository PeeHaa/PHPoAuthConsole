 ...
 * @version    1.0.0
 */
namespace PHPoAuthConsole\Network\Http;

use PHPoAuthConsole\Storage\ImmutableKeyValue;
...
{
    /**
     * @var \PHPoAuthConsole\Storage\ImmutableKeyValue The path variables
     */
    private $pathVariables;

    /**
     * @var \PHPoAuthConsole\Storage\ImmutableKeyValue The GET variables
     */
    private $getVariables;

    /**
     * @var \PHPoAuthConsole\Storage\ImmutableKeyValue The POST variables
     */
    private $postVariables;

    /**
     * @var \PHPoAuthConsole\Storage\ImmutableKeyValue The SERVER variables
     */
    private $serverVariables;

    /**
     * @var \PHPoAuthConsole\Storage\ImmutableKeyValue The FILES variables
     */
    private $filesVariables;

    /**
     * @var \PHPoAuthConsole\Storage\ImmutableKeyValue The COOKIES variables
     */
    private $cookies;
     ...
     * Creates instance
     *
     * @param \PHPoAuthConsole\Storage\ImmutableKeyValue $pathVariables   The path variables
     * @param \PHPoAuthConsole\Storage\ImmutableKeyValue $getVariables    The GET variables
     * @param \PHPoAuthConsole\Storage\ImmutableKeyValue $postVariables   The POST variables
     * @param \PHPoAuthConsole\Storage\ImmutableKeyValue $serverVariables The SERVER variables
     * @param \PHPoAuthConsole\Storage\ImmutableKeyValue $filesVariables  The FILES variables
     * @param \PHPoAuthConsole\Storage\ImmutableKeyValue $cookies         The COOKIE variables
     */
